/**
 * Based on 'no_limit.coffee' from binions: https://github.com/mdp/binions/blob/master/src/betting/no_limit.coffee
 */
// Generated by CoffeeScript 1.3.3
module.exports = function(blinds, initialPlayers) {
    var Analysis;

    return Analysis = (function(blinds, initialPlayers) {

        function Analysis(players, state) {
            this.state = state;
            this.players = players;
            this.blindSteps = blinds;
            ...
            this.roundMinimum = this.get_big();
            this.analyze();
        }
        ...
        Analysis.prototype.get_small = function() {
            let index = Math.min(this.initialPlayers - this.players.length, this.blindSteps.length - 1);
            return this.blindSteps[index];
        }

        Analysis.prototype.get_big = function() {
            return this.get_small() * 2;
        }

        Analysis.prototype.blinds = function() {
            let small = this.get_small();
            let big = this.get_big();

            // console.log(`Blinds are now: ${small} / ${big}`)
